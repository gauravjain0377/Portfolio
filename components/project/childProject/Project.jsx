...
const Project = ({ title, manageModal, index, githubUrl }) => {
  return (
    <div 
      ...
      onMouseEnter={(e) => {
        ...
        // Only trigger hover if cursor is in the left area (project names area)
        if (x < rect.left + rect.width * 0.6) {
          console.log('DEBUG: Hover triggered - cursor in left area');
